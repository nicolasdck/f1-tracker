...
export default function handler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var apiKey, raceDate, keywordsParam, keywords, match, cacheControl, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    raceDate = typeof req.query.raceDate === "string" ? req.query.raceDate : undefined;
                    keywordsParam = typeof req.query.keywords === "string" ? req.query.keywords : "";
                ...
                case 3:
                    err_1 = _a.sent();
                    res.status(502).json({ error: err_1 instanceof Error ? err_1.message : "Erreur inconnue" });
                    return [3 /*break*/, 4];
