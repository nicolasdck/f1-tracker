	...
	return (
		<div className="mb-4">
			<button
				...
				style={{
					color: shown ? 'var(--color-primary)' : 'rgba(255,255,255,0.4)',
				}}
			>
				Lollipopman Comics
				<Film size={13} />
			...
			{shown &&
				(playing ? (
					<div className="relative w-full overflow-hidden rounded border border-white/8 pb-[56.25%]">
						<iframe
					...
					<button
						...
						className="group relative block w-full overflow-hidden rounded border border-white/8 pb-[56.25%]"
