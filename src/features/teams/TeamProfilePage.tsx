...
export function TeamProfilePage() {
	...
	const { data: standings, isLoading: standingsLoading } =
		useConstructorStandings();
	const { data: races, isLoading: resultsLoading } =
		useConstructorSeasonResults(constructorId ?? '');
	...
	const carPhoto = constructorInfo
		? getTeamCarPhoto(constructorInfo.constructorId)
		: undefined;
				...
				<div className="flex items-center gap-4 p-4 pt-0">
					...
					<div>
						...
						<div className="flex items-center gap-1.5 text-xs text-white/50">
							<Flag
								code={getNationalityFlagCode(constructorInfo.nationality)}
							/>
